    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_list', models.TextField(blank=True, help_text='List of filenames of JPEGImages to be used as video frames, in JSON format.When present, image list is assumed and <filename> is ignored.')),
                ('host', models.CharField(blank=True, help_text='Path to prepend to filenames to form the url for this video or the JPEGImages in `image_list`.', max_length=1048)),
